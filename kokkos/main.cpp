...
int main(int argc, char** argv){
  ...
  
  {
    ...
    sw.stop();
    std::cout << "        Time:   " << sw.get() << " s\n";
    std::cout << "@ PRODUCT1DRKOKKOSMT " << n_x[0] << " "  << sw.get() << "\n";
    ...
    sw.stop();
    std::cout << "        Time:   " << sw.get() << " s\n";
    std::cout << "@ PRODUCT1DRKOKKOSGPU " << n_x[0] << " "  << sw.get() << "\n";
    error=(multiplied_signals.front()-sig/n_coils).norm();
    std::cout << "        Error:  " << error << "\n";
    std::cout << "\n";
  }
  ...
  
  {
    ...
    sw.stop();
    std::cout << "        Time:   " << sw.get() << " s\n";
    std::cout << "@ PRODUCT1DCKOKKOSMT " << n_x[0] << " "  << sw.get() << "\n";
    error=(multiplied_signals.front()-sig/n_coils).norm();
    std::cout << "        Error:  " << error << "\n";
    std::cout << "\n";
    ...
    sw.stop();
    std::cout << "        Time:   " << sw.get() << " s\n";
    std::cout << "@ PRODUCT1DCKOKKOSGPU " << n_x[0] << " "  << sw.get() << "\n";
    error=(multiplied_signals.front()-sig/n_coils).norm();
    std::cout << "        Error:  " << error << "\n";
    std::cout << "\n";
  }
